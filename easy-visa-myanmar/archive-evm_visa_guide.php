...
<main id="primary" class="site-main">
  <section class="page-hero evm-guide-archive-hero">
    <div class="evm-container">
      ...
      <h1><?php esc_html_e('Helpful guides for visa, travel and support services', 'easy-visa-myanmar'); ?></h1>
      <p><?php esc_html_e('Read simple customer guides before submitting a request. Guides are separate from the booking forms, so customers can learn first and request service when ready.', 'easy-visa-myanmar'); ?></p>
    </div>
  </section>
      ...
      <div class="evm-guide-grid evm-guide-grid-archive">
        ...
        <?php else : ?>
          <article class="entry-content">
            ...
            <p><?php esc_html_e('Add guides from WordPress Admin → Visa Guides.', 'easy-visa-myanmar'); ?></p>
          </article>
        <?php endif; ?>
      </div>
